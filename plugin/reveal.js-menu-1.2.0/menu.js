...
var RevealMenu = window.RevealMenu || (function () {
    ...
    function loadPlugin() {
        ...
        if (initialise) {
            ...
            } else if (transitions !== false && (!Array.isArray(transitions) || !transitions.every(function (e) {
            ...
            if (keyboard) {
                ...
                window.addEventListener('message', function (event) {
                    ...
                    if (data && data.method === 'triggerKey') {
                        onDocumentKeyDown({
                            keyCode: data.args[0], stopImmediatePropagation: function () {
                            }
                        });
                    }
                });
            ...
            function openMenu(event) {
                ...
                if (!isOpen()) {
                    ...
                    if (transitions) {
                        ...
                        selectAll('li[data-transition="' + Reveal.getConfig().transition + '"]').forEach(function (i) {
                            i.classList.add('active')
                        });
                    }
